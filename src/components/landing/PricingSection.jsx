    ...
    <section id="precios" className="py-24 bg-slate-50 border-t border-slate-200">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-slate-900 mb-4">Planes que crecen contigo</h2>
          <p className="text-slate-600 text-lg max-w-3xl mx-auto">Elige el plan de acuerdo con el tamaño de tu organización y obtén acceso a las herramientas de evaluación, analítica y seguimiento de Clima Laboral IA.</p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="py-4 px-6 font-medium text-slate-800">Hasta 50</td>
                  <td className="py-4 px-6 text-right text-slate-600">$999</td>
                  <td className="py-4 px-6 text-right font-bold text-slate-900">$9,990</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="py-4 px-6 font-medium text-slate-800">51 – 150</td>
                  <td className="py-4 px-6 text-right text-slate-600">$1,799</td>
                  <td className="py-4 px-6 text-right font-bold text-slate-900">$17,990</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors bg-indigo-50/30">
                  ...
                  <td className="py-4 px-6 text-right text-slate-600">$2,999</td>
                  <td className="py-4 px-6 text-right font-bold text-indigo-700">$29,990</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="py-4 px-6 font-medium text-slate-800">301 – 500</td>
                  <td className="py-4 px-6 text-right text-slate-600">$4,999</td>
                  <td className="py-4 px-6 text-right font-bold text-slate-900">$49,990</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="py-4 px-6 font-medium text-slate-800">501 – 1,000</td>
                  <td className="py-4 px-6 text-right text-slate-600">$8,999</td>
                  <td className="py-4 px-6 text-right font-bold text-slate-900">$89,990</td>
                </tr>
